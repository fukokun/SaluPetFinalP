    ...
    <div class="modal-dialog">
		...
		<form method="POST" autocomplete="off" enctype="multipart/form-data">
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								<label>CURP</label>
								<input name="dnidoc" required="" type="text" class="form-control" maxlength="8" placeholder="Ingrese curp" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
							</div>
						</div>
					...
					<select class="form-control" name="naciona">
						<option value="Peruana(o)">Mexicana(o)</option>
